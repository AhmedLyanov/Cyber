<template>
  <NuxtLink :to="`/product/${props.product._id}`"
    ...
    <AddToCartButton class="w-full flex items-center justify-end" :product-id="props.product._id">
...
import AddToCartButton from "~/features/add-to-cart/ui/add-to-card.vue";
